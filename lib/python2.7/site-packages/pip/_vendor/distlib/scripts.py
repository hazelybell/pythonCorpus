...
from pip._vendor.distlib.compat import sysconfig, fsencode, detect_encoding, ZipFile
from pip._vendor.distlib.resources import finder
from pip._vendor.distlib.util import FileOperator, get_export_entry, convert_path, get_executable
